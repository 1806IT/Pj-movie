...
!function(){
    ...
    Top250.prototype.bind=function () {/*{绑定事件*/
        var self = this;
        this.$element.scroll(() => {
    ...
    Top250.prototype.start=function () {/*获取数据并渲染*/
            var self = this
    ...
    Top250.prototype.getData=function (callback) {/*获取数据*/
            var self = this
    ...
    Top250.prototype.render=function (data) {
            ...
            data.subjects.forEach(function (movie){
                self.$container.append(Common.createNode(movie))
            })
        }      
